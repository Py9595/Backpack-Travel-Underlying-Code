...
class BackpacktravelAlliancesTx;
class Transactor;
class TableStorage
{
public:
...
private:
    ...
    TER TableStorageHandlePut(BackpacktravelAlliancesTx& transactor,uint160 uTxDBName, AccountID accountID, std::string sTableName, uint32 lastLedgerSequence, uint256 txhash, STTx const & tx);
