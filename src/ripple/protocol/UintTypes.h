...
/** BTA currency. */
Currency const& btaCurrency();

/** A placeholder for empty currencies. */
Currency const& noCurrency();

/** We deliberately disallow the currency that looks like "BTA" because too
    many people were using it instead of the correct BTA currency. */
Currency const& badCurrency();

inline bool isBTA(Currency const& c)
{
    return c == zero;
}

/** Returns "", "BTA", or three letter ISO code. */
