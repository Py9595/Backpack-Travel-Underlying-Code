...
private:
    ...
    bool mIsNative;      // A shorthand for isBTA(mIssue).
    bool mIsNegative;
...
public:
    ...
    STAmount (BTAAmount const& amount);
...
public:
    ...
    STAmount& operator= (BTAAmount const& amount)
    {
...
// IOUAmount and BTAAmount define toSTAmount, defining this
...
inline bool isBTA(STAmount const& amount)
{
    return isBTA (amount.issue().currency);
}
