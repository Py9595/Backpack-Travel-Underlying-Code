...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send BTA to create it."                            } },
        { tecNO_DST_INSUF_BTA,       { "tecNO_DST_INSUF_BTA",      "Destination does not exist. Too little BTA sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient BTA balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient BTA balance to send."                                             } },
		...
		{ temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not BTA."                                             } },
		...
		{ temBAD_SEND_BTA_LIMIT,     { "temBAD_SEND_BTA_LIMIT",    "Malformed: Limit quality is not allowed for BTA to BTA."                       } },
		{ temBAD_SEND_BTA_MAX,       { "temBAD_SEND_BTA_MAX",      "Malformed: Send max is not allowed for BTA to BTA."                            } },
		{ temBAD_SEND_BTA_NO_DIRECT, { "temBAD_SEND_BTA_NO_DIRECT","Malformed: No Ripple direct is not allowed for BTA to BTA."                    } },
		{ temBAD_SEND_BTA_PARTIAL,   { "temBAD_SEND_BTA_PARTIAL",  "Malformed: Partial payment is not allowed for BTA to BTA."                     } },
		{ temBAD_SEND_BTA_PATHS,     { "temBAD_SEND_BTA_PATHS",    "Malformed: Paths are not allowed for BTA to BTA."                              } },
