...
TxFormats::TxFormats ()
{
    ...
    Item &itemTableListSet = add("TableListSet", ttTABLELISTSET)
        ...
        ;
    addBackpacktravelAlliancesCommondFields(itemTableListSet);
    ...
    Item &itemSqlStatement = add("SQLStatement", ttSQLSTATEMENT)
		...
		<< SOElement(sfTxCheckHash,         SOE_OPTIONAL)
        ;
    addBackpacktravelAlliancesCommondFields(itemSqlStatement);
    ...
    Item &itemSqlTransaction = add("SQLTransaction", ttSQLTRANSACTION)
        ...
        ;
    addBackpacktravelAlliancesCommondFields(itemSqlTransaction);
}
...
void TxFormats::addBackpacktravelAlliancesCommondFields(Item& item)
{
    item
