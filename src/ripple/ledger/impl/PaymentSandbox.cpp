        ...
        STAmount const& amount) const
{
    ...
    */
    ...
    if (isBTA(issuer) && adjustedAmt < beast::zero)
        // A calculated negative BTA balance is not an error case. Consider a
        // payment snippet that credits a large BTA amount and then debits the
...
PaymentSandbox::balanceChanges (ReadView const& view) const
{
    ...
    // get the change in BTA balance, Account == root, issuer == root, currency == BTA
...
BTAAmount PaymentSandbox::btaDestroyed () const
{
