...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an BTA balance equal to the total amount
        of BTA in the system. No more BTA than the amount which
    ...
    */
    ...
    void
    rawDestroyBTA (BTAAmount const& fee) override
    {
        info_.drops -= fee;
    }
