...
protected:
    ...
    AccountID     account_;
    BTAAmount     mFeeDue;
    BTAAmount     mPriorBalance;  // Balance before fees.
    BTAAmount     mSourceBalance; // Balance after fees.
...
private:
    void setSeq ();
    TER payFee ();
    void claimFee (BTAAmount& fee, TER terResult, std::vector<uint256> const& removedOffers);
