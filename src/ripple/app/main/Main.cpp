...
int run (int argc, char** argv)
{
    ...
    beast::setCurrentThreadName ("backpacktravelalliancesd: main");
    ...
    {
        std::cerr << "backpacktravelalliancesd: Incorrect command line syntax." << std::endl;
    ...
    if (vm.count ("version"))
    {
        std::cout << "backpacktravelalliancesd version " <<
    ...
    beast::setCurrentThreadName ("backpacktravelalliancesd: rpc");
...
int main (int argc, char** argv)
{
    ...
    static_assert (gccver >= 50100,
        "GCC version 5.1.0 or later is required to compile backpacktravelalliancesd.");
#endif

    static_assert (BOOST_VERSION >= 105700,
        "Boost version 1.57 or later is required to compile backpacktravelalliancesd");
