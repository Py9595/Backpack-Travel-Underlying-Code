...
public:
    ...
    */
    ...
    enum NodeType
    {
        ...
        nt_BTA_BOOK,   // The order book from this currency to BTA.
    ...
    enum PaymentType
    {
        ...
        pt_BTA_to_nonBTA,
        pt_nonBTA_to_BTA,
        pt_nonBTA_to_same,   // Destination currency is the same as source.
        pt_nonBTA_to_nonBTA  // Destination currency is NOT the same as source.
    };
...
private:
    ...
    // Add order book to BTA only
    static std::uint32_t const afOB_BTA = 0x010;
