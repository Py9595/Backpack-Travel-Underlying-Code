...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/BTA offer book
     BookStepXI is an BTA/IOU offer book
     BTAEndpointStep is the source or destination account for BTA
...
public:
    ...
    */
    ...
    // For BTA endpoints, one of src or dst will be the root account
