...
public:
    ...
    void testLedgerType()
    {
        ...
        env(offer(Account{"bob0"}, USD(100), BTA(100)));
...

        {
            ...
            jv[jss::Amount] = BTA(50).value().getJson(0);
...

        {
            ...
            jv[jss::Amount] = BTA(100).value().getJson (0);
