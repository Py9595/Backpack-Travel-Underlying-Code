...
public:
    ...
    void testNullAccountSet()
    {
        ...
        env.fund(BTA(10000), noripple(alice));
    ...
    void testBadInputs(bool withFeatures)
    {
        ...
        auto jt = fset(alice, asfDisallowBTA);
        jt[jss::ClearFlag] = asfDisallowBTA;
        ...
        jt = fset(alice, asfDisallowBTA);
        jt[sfFlags.fieldName] = tfAllowBTA;
        env(jt, ter(temINVALID_FLAG));
