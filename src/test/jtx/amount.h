...
The decision was made to accept amounts of drops and BTA
using an int type, since the range of BTA is 100 billion
...
/** Represents an BTA or IOU quantity
    This customizes the string conversion and supports
    BTA conversions from integer and floating point.
*/
struct PrettyAmount
{
private:
...
struct BTA_t
{
    ...
    */
    ...
    /** Returns an amount of BTA as STAmount

        @param v The number of BTA (not drops)
    */
    /** @{ */
    ...
    friend
    BookSpec
    operator~ (BTA_t const&)
    {        
        return BookSpec( btaAccount(),
            btaCurrency() );
    }
};

/** Converts to BTA Issue or STAmount.

    Examples:
        BTA         Converts to the BTA Issue
        BTA(10)     Returns STAmount of 10 BTA
*/
extern BTA_t const BTA;

/** Returns an BTA STAmount.
