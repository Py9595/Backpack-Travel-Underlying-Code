...
public:
    ...
    */
    ...
    /** Returns the BTA balance on an account.
...
public:
    ...
    /** Create a new account with some BTA.
        ...
        Effects:
            ...
            The account's BTA balance is set to amount.

            Generates a test that the balance is set.

        @param amount The amount of BTA to transfer to
                      each account.
